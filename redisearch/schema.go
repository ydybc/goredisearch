...
func SerializeSchema(s *Schema, args goRedis.Args) (argsOut goRedis.Args, err error) {
	argsOut = args
...
func serializeField(f Field, args goRedis.Args) (argsOut goRedis.Args, err error) {
	argsOut = args
	switch f.Type {
	case TextField:
